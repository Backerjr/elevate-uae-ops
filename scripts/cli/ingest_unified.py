...
from backend.lib.catalog_manager import CatalogManager
...
BATCH_DATA = [
    {
        ...
        "pricing": [
            {"tier_name": "General Admission – Adult/Child", "price_aed": 149, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Adult – General Admission", "price_aed": 55, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"},
            {"tier_name": "Child – General Admission", "price_aed": 20, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Adult – General Entry", "price_aed": 140, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"},
            {"tier_name": "Child – General Entry", "price_aed": 120, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Observatory + Glass Slide", "price_aed": 85, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"},
            {"tier_name": "Edge Walk Upgrade", "price_aed": 504, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Standard View – Shared Cabin", "price_aed": 130, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"},
            {"tier_name": "Premium View – Shared Cabin", "price_aed": 180, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "General Admission", "price_aed": 95, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Adult – Palace Entry", "price_aed": 65, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"},
            {"tier_name": "Child – Palace Entry", "price_aed": 30, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Adult – General Admission", "price_aed": 63, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Guided Visit – Per Person", "price_aed": 50, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Adult – General Entry", "price_aed": 25, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
    ...
    },
    {
        ...
        "pricing": [
            {"tier_name": "Per Person – Museum Entry", "price_aed": 10, "currency": "AED", "validity_start": "2025-12-12", "validity_end": "2026-12-31"}
        ],
...
def main():
    db_path = os.path.join(project_root, "data", "products.json")
    manager = CatalogManager(db_path=db_path)
    
    try:
        logger.info(f"Starting ingestion of Batch 3 - Segment F (Culture & Museums)")
        logger.info(f"Target database: {db_path}")
        
        count = manager.upsert_batch(BATCH_DATA)
        
        logger.info(f"Successfully processed {count} items")
        print(f"\n✓ Successfully processed {count} items")
        
    except BlockingIOError:
        logger.error("Database is currently locked")
        print("\n✗ System is busy, try again in 30s.")
        sys.exit(1)
        
    except ValidationError as e:
        logger.error(f"Validation error: {e}")
        print(f"\n✗ Validation failed for product. Check logs for details.")
        sys.exit(1)
